...
rule all:
    input:
        ...
        # ,
        # expand("data/output/satellite_pm25_raster2polygon/satellite_pm25_{shape}_{year}{month}.parquet", 
        #     shape=defaults_dict['shapefiles'], 
        #     year=years_list, 
...
rule download_annual_pm25:
    params:
        ...
        year = "{year}"
    output:
        "data/input/satellite_pm25/{zipname}/{file_prefix}.{year}01-{year}12.nc"
    shell:
        "python src/download_pm25.py satellite_pm25=annual"
...
rule aggregate_annual:
    ...
    input:
        ...
        expand("data/input/satellite_pm25/{zipname}/{file_prefix}.{year}01-{year}12.nc", 
               zipname=satellite_pm25_cfg["zipname"],
               file_prefix=satellite_pm25_cfg["file_prefix"],
               year=years_list
               )
    output:
